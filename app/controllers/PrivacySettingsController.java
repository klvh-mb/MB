...
public class PrivacySettingsController extends Controller {
    private static play.api.Logger logger = play.api.Logger.apply(PrivacySettingsController.class);
    
    @Transactional
    public static Result saveSettings() {
        DynamicForm form = DynamicForm.form().bindFromRequest();
        
        logger.underlyingLogger().debug(form.get("activity")+form.get("joinedCommunity")+form.get("friendList")+form.get("detail"));
