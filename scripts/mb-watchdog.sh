...
# 9001 - port of MB process
# 9002 - port of MB Image process
NAME1=9001
NAME2=9002

TO1=vichoty@gmail.com
...
case "$?" in
 1)
 echo "MB $NAME1 is NOT RUNNING. Sending notices."
...
case "$?" in
 1)
 echo "MB $NAME2 is NOT RUNNING. Sending notices."
